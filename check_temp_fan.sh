...
#
# NAME:
#   check_temp_fan.sh - Check the SoC temperature and control a fan
#
# SYNOPSIS:
...
#   -4
#      Force fan on. Simulate exceeding fan turning on temperature.
#   -5
#      Force fan off. Simulate exceeding fan turning off temperature.
#
# LICENSE:
...
CONFIG_flag_force_fanon=0                 # Force fan on temperature flag
...
then
  ...
  then
    # Notify (in cron email) just at higher current temperature than previous one or at the first time
